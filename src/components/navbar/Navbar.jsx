...
const Navbar = () => {
  ...
  return (
    <div className="w-full h-[8ch] bg-[#2963BB2B] flex items-center md:flex-row lg:px-28 md:px-16 sm:px-7 px-4 fixed top-0 z-50">
      {/* Logo section */}
          ...
          <div className="relative bg-violet-600 rounded-md px-8 py-2 w-fit cursor-pointer">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs font-normal text-neutral-50 tracking-wide">
                <p>
                  <a href="tel:+911234567890">+91 8174911900</a>
                </p>
