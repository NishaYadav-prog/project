...
const Hero = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-8ch)] lg:px-28 md:px-16 sm:px-7 px-4 mt-[8ch] flex items-center justify-center flex-col  relative">
      <div className="flex-1 w-full flex items-stretch justify-between gap-12.pb-10">
        ...
        >
          ...
          >
            ...
            >
              Find and book your train tickets with just a few clicks. We offer
              a wide range of bus routes and schedules to suit your needs.
            </motion.p>
          </motion.div>
